  ...
  async lsAnnotations(_opts: { json?: boolean }) {
    ...
    for await (const a of anns.catalog()) {
      ...
      table.push([
        ...
        a.resourceAnn?.error ? z.prettifyError(a.resourceAnn.error) : "",
    ...
    return new Command()
      ...
      .command(
        ...
        new Command()
          ...
          .command("head")
          .action(async () => await this.lsSqlSources({ target: "head" }))
          .command("tail")
          .action(async () => await this.lsSqlSources({ target: "tail" })),
      )
      .command(
        "sql",
        new Command()
          ...
          .command("head")
          .action(async (opts) => await this.SQL({ target: "head", ...opts }))
          .command("tail")
          .action(async (opts) => await this.SQL({ target: "tail", ...opts }))
      ...
      .action(async (opts) => await this.SQL({ target: "deploy", ...opts }))
      .command("dev")
