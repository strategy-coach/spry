...
SELECT COALESCE(sqlpage.environment_variable('SQLPAGE_SITE_PREFIX'), '') || '/spry/console/info-schema/populate-spry-table-info.sql' AS link, 'info' AS color, 'Rebuild spry_table_info table' AS title;
